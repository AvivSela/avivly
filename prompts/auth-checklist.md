...
- [ ] `prompts/k8s-01-namespace-secret.md`
- [ ] `prompts/k8s-02-configmap.md`
- [ ] `prompts/k8s-03-postgres.md`
- [ ] `prompts/k8s-04-backend.md`
- [ ] `prompts/k8s-05-frontend.md`
- [ ] `prompts/k8s-06-nginx.md`
- [ ] `prompts/auth-11-link-controller.md`
- [ ] `prompts/auth-12-run-tests.md`
- [ ] `prompts/auth-13-auth-controller-test.md`
- [ ] `prompts/auth-14-link-auth-test.md`
