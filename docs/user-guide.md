...
## The Link Expiry Page

If someone follows a short link that has expired (past its expiry date or past its click limit), they are redirected to `/link-expired` — a page that informs them the link is no longer valid.
